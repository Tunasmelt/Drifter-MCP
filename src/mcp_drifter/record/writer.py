...
from mcp_drifter.record.fingerprint import build_environment, compute_tool_manifest_hash
...
from mcp_drifter.record.segment import Trajectory, TrajectoryTracker, extract_trace_id
